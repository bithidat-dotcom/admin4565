    ...
    <div className="flex-1 overflow-x-hidden pb-24 md:pb-0">
      ...
      <main className="p-4 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-brand p-6 rounded-3xl shadow-xl shadow-brand/20 hover:shadow-brand/30 transition-all cursor-pointer group" onClick={() => setIsAddModalOpen(true)}>
             ...
             <p className="text-sm font-black text-white uppercase tracking-wider">Create New Order</p>
             <p className="text-[9px] text-white/60 font-bold uppercase mt-1">Add manual shipment data</p>
          </div>
        </div>
      ...
      >
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
          <div>
            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Order Entry</p>
            <p className="text-[9px] text-slate-400 font-bold uppercase mt-0.5">Enter shipment details manually</p>
          </div>
          <div className="flex items-center gap-2">
            <button 
              type="button"
